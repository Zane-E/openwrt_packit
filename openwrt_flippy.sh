...
PACKAGE_OPENWRT=(
    ...
    "watermelon-pi" "zcube1-max" "jp-tvbox" "ht2" "e20c" "h28k" "h66k" "h68k" "h69k" "h69k-max" "panther-x2" "tvi3315a"
    "beikeyun" "l1pro"
    "vplus"
...
PACKAGE_OPENWRT_6XY=("r66s" "r68s" "e25" "photonicat" "cm3" "rk3399"  "panther-x2" "tvi3315a")
